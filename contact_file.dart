...
class ContactHelper{
  ...
  Future<Database> initDb() async {
    ...
    return await openDatabase(path, version: 1, onCreate: (Database db, int newerVersion) async {
      await db.execute(
        "CREATE TABLE $contactTable($idColumn INTEGER PRIMERY KEY, $nameColumn TEXT,"
            "$momColumn TEXT, $cpfColumn TEXT, $rgColumn TEXT, $datebornColumn DATE,"
            "$andressColumn TEXT, $phoneColumn TEXT, $validColumn TEXT,"
  ...
  Future<Contact> getContact(int id) async{
    ...
    columns: [imgColumn, nameColumn, momColumn, cpfColumn, rgColumn, datebornColumn, andressColumn, phoneColumn, noteColumn, validColumn, planColumn, costColumn, emailColumn, imgColumn],
    where:  "$imgColumn = ?",
    whereArgs: [id]);
